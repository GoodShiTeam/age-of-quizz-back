...
public class Question {
	...
	public enum QuestionCivilisation {
		...
		VIETNAMESE, VIKINGS, WEI, WU, MAPUCHE, MUISCA, TUPI
	}

	public enum QuestionBuilding {

		NONE, TOWN_CENTER, MARKET, LUMBER_CAMP, MINING_CAMP, DOCK, BLACKSMITH, UNIVERSITY, BARRACKS, ARCHERY_RANGE,
		STABLE, SIEGE_WORKSHOP, MONASTERY, CASTLE, TOWER, MILL
